...
export const JupIcon = ({ size = 16 }) => {
  return (
    ...
    >
      <path
        d="M24.1464 196.614C34.7084 211.305 48.2565 223.598 63.9023 232.686C79.5482 241.774 96.9383 247.452 114.932 249.348C105.675 235.417 92.218 222.6 75.4183 212.842C58.6186 203.084 40.8275 197.754 24.1464 196.614Z"
        fill="url(#paint0_linear_585_224)"
      />
      <path
        d="M97.9925 173.988C65.6261 155.185 30.5947 150.393 5.52861 158.858C7.94843 166.856 11.1398 174.599 15.0576 181.979C36.8358 181.475 60.6138 187.39 82.7394 200.241C104.865 213.092 121.787 230.828 132.143 250C140.499 249.743 148.811 248.679 156.963 246.822C151.896 220.858 130.35 192.796 97.9925 173.988Z"
        fill="url(#paint1_linear_585_224)"
      />
      <path
        d="M252.229 97.6632C248.113 80.925 240.668 65.1877 230.336 51.3909C220.004 37.5942 206.997 26.0209 192.093 17.3621C177.189 8.70339 160.693 3.13675 143.59 0.994609C126.487 -1.14753 109.128 0.17875 92.5489 4.89426C120.246 8.28386 150.99 18.6814 181.14 36.1972C211.291 53.7129 235.573 75.2665 252.229 97.6632Z"
        fill="url(#paint2_linear_585_224)"
      />
      <path
        d="M211.93 159.049C197.753 135.505 173.467 112.959 143.55 95.5793C113.632 78.1992 82.0242 68.2719 54.5727 67.6152C30.4219 67.0432 12.296 74.0639 4.85584 86.8723C4.81347 86.9486 4.75415 87.0206 4.70754 87.0969C4.0381 89.4992 3.46187 91.9058 2.93648 94.3209C13.3256 90.2195 25.3629 87.9358 38.7476 87.6816C68.5124 87.1223 101.824 96.6428 132.563 114.502C163.302 132.361 188.093 156.592 202.346 182.717C208.736 194.488 212.723 206.076 214.303 217.147C216.142 215.503 217.947 213.804 219.697 212.037C219.743 211.957 219.773 211.872 219.82 211.787C227.26 198.966 224.383 179.747 211.93 159.049Z"
        fill="url(#paint3_linear_585_224)"
      />
      <path
        d="M120.788 134.754C74.9736 108.137 24.3458 103.968 -4.16891e-06 122.543C0.0478158 128.357 0.492313 134.161 1.3304 139.915C8.49209 137.744 15.8732 136.377 23.3373 135.839C50.5431 133.792 80.5368 141.372 107.755 157.193C134.974 173.014 156.43 195.326 168.132 219.956C171.367 226.703 173.834 233.792 175.488 241.09C180.902 238.967 186.167 236.48 191.245 233.646C195.321 203.292 166.616 161.375 120.788 134.754Z"
        fill="url(#paint4_linear_585_224)"
      />
      <path
        d="M235.496 119.641C221.158 96.1218 196.659 73.5132 166.53 56.0187C136.401 38.5241 104.67 28.4401 77.1295 27.6308C56.1352 27.0249 39.8736 32.1135 31.4419 41.7273C66.4522 35.7955 112.631 45.7651 157.391 71.7676C202.15 97.77 233.699 132.954 245.876 166.303C250.05 154.224 246.419 137.577 235.496 119.641Z"
        fill="url(#paint5_linear_585_224)"
      />
      <defs>
        <linearGradient
          id="paint0_linear_585_224"
          x1="167.969"
          y1="50.7813"
          x2="52.0834"
          y2="250"
...
export const CircuitIcon = ({ size = 16, color = '#000000' }: { size?: number, color?: string }) => (
  <svg  
  height={size}
  viewBox="0 0 24 24"
  fill={color}
